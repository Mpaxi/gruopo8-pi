...
//        sixthQuestion();
    ...
    public static void firstQuestion() {
        System.out.println("");
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println("|  Voc� est� no come�o do seu expediente, vamos come�ar com o plano com calma. Primeiro de tudo, |");
        System.out.println("|  vamos ligar o computador. Para ligar o computador escolha a alternativa que                   |");
        System.out.println("|  N�O tem rela��o com estruturas de repeti��o.                                                  |");
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println("");
        ...
        mylist.add("Incrementa��es");
        mylist.add("Bifurca��o");

        verifyAnswer(mylist, "Bifurca��o", 0);
    ...
    public static void secondQuestion() {
        System.out.println("");
        System.out.println("----------------------------------------------------------------------------------------------------");
        System.out.println("|  Pronto, conseguimos logar, gra�as � sua boa mem�ria! (nem tanto por demorar um pouco).           |");
        System.out.println("|  Agora precisamos desativar o firewall do sistema sem que ningu�m perceba,                        |");
        System.out.println("|  para isso resolva esta pequena quest�o: �O uso de vari�veis � extremamente comum em programa��o. |");
        System.out.println("|  Escolha uma vari�vel que n�o seja primitiva em Java.�                                            |");
        System.out.println("----------------------------------------------------------------------------------------------------");
        System.out.println("");
